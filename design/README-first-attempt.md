...
This whole project was kind of predicated on the idea that game trees form the bulk of the play experience. That idea might not be true! A test would be to make two game applications that are very different, with an identical game tree.
